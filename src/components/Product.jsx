...
// import { addToCart, addToWishlist, setItemQuantity } from "./actions/ProductAction";
...
//     return null;
//   }
//   const handleWishlist = (product2) => {
//     dispatch(addToWishlist(product2))
//     navigate('/wishlist')
//   };
//   return (
//     <>
...
//               <CiHeart width={200} onClick={()=>handleWishlist(product)} />
//             </p>
//           </button>
//           <p className="bg-white w-10 h-10 rounded-full flex items-center justify-center">
