...
//                 </button>
//                 <button 
//                   className={`border-blue-300 shadow-lg rounded-2xl px-4 py-2 ${clickedButton === 'change title' ? 'color-blue text-white font-bold border-0font-bold border-0' : 'bg-white'}`}
...
//                   Other
//                 </button>
//                 <input type="range" id="range" name="range" min={45} max={100} />
//               </div>
